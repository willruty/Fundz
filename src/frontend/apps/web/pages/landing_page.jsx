                        ...
                        <div id="security-info">
                            ...
                            <div id="security-cards">
                                <div className="security-card">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="#FFD100" class="bi bi-emoji-angry" viewBox="0 0 16 16">
                                ...
                                <div className="security-card">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="#FFD100" class="bi bi-crosshair" viewBox="0 0 16 16">
